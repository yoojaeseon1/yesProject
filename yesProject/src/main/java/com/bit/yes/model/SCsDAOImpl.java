...
@Repository
public class SCsDAOImpl implements SCsDAO {
	...
	@Override
	public SCsVo selcetOne(int index) throws SQLException {
		// TODO Auto-generated method stub
		return sqlSession.selectOne("yes.s_selectOne", index);
	}

	@Override
	public int insertOne(SCsVo bean) throws SQLException {
...
//	}
	...
	public List<SCsVo> writeList(HashMap<String, Object> params) throws SQLException {
		List<SCsVo> writeList = new ArrayList<SCsVo>();
