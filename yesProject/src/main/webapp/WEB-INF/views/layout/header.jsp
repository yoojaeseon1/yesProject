...
<!-- jQuery Modal -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mainStyle.css?ver=10">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/insertstyle.css?ver=8">
		...
		<div id="slide-menu">
			<ul style="width: 100%; padding-left: 5px;">
				<c:if test="${member.registNum=='0' }">
					<li><a href="/myReservation">예약 현황</a></li>
					<li><a href="/myReviewWrite">작성글 보기</a></li>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="${pageContext.request.contextPath}/reviewList"
	...
	<div id="login" class="modal">
		...
		<div id="login-findID">
			...
			<form class="form-horizontal" id="findIDForm">
				...
				<div class="form-group">
					<input type="submit" id="findID_btn" class="btn btn-default"
						value="아이디찾기" />
				</div>
...
<%--mybranch modal--%>
<script
	src="${pageContext.request.contextPath}/resources/js/header_js/mybranch.js"></script>
<%--etc : markerImageList() && loadFile--%>
<script
	src="${pageContext.request.contextPath}/resources/js/header_js/etc.js"></script>
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.js"></script>
</html>