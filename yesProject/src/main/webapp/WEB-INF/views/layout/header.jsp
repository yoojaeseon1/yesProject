...
<!-- jQuery Modal -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mainStyle.css?ver=8">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/insertstyle.css?ver=4">
...
<script
	src="${pageContext.request.contextPath}/resources/js/calendar/clndr.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/calendar/clndr2.js"></script>

<!-- jQuery validate -->
<script
	src="${pageContext.request.contextPath}/resources/js/validate/jquery.validate.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/validate/additional-methods.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/validate/messages_ko.min.js"></script>
...
<body>
	<div id="slide">
		<a id="closeMypage" data-dismiss="modal"
			style="float: right; color: black; font-size: 25px;">X</a>
		...
		<div id="slide-menu">
			<ul style="width: 100%; padding-left: 5px;">
				...
				<c:if test="${member.registNum!='0' }">
					<li><a
						href="${pageContext.request.contextPath}/branchReserve.yes">예약
							현황</a></li>
					<li><a
						href="${pageContext.request.contextPath}/branch_ReviewList.yes">리뷰게시판</a></li>
					<li><a href="${pageContext.request.contextPath}/myInfo.yes">내정보</a></li>
					<c:choose>
						<c:when test="${member.acceptState=='true'}">
							<li><a href="#modal3" rel="modal:open"
								onclick="javascript:myBranch();" style="width: 100%;">매장정보</a></li>
						</c:when>
						<c:when test="${member.acceptState=='false'}">
							<li><a href="#modal3" rel="modal:open"
								onclick="javascript:myBranch();" style="width: 100%;">등록 요청
									정보</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="#modal2" rel="modal:open"
								onclick="javascript:modalStep1();" style="width: 100%;">매장
									등록</a></li>
						</c:otherwise>
					</c:choose>
									...
									<c:choose>
										<c:when test="${member.registNum == '0'}">
											<c:if test="${member.id != 'admin'}">
												<li><a
													href="${pageContext.request.contextPath}/yesC_cs/">고객
														상담</a></li>
											</c:if>
										</c:when>
										<c:when test="${member.registNum != '0'}">
											<c:if test="${member.id != 'admin'}">
												<li><a
													href="${pageContext.request.contextPath}/yesS_cs/">사업자
														상담</a></li>
											</c:if>
...
예스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
				...
				<div id="radioGroup">
					<input type="radio" name="assent" class="okbtn" value="ok" /> 동의 <input
						type="radio" name="assent" value="no" /> 동의하지않음
				</div>

				<div class="choice">
					<a id="custom" href="#" class="btn-gradient red block"
						role="button">고객</a> <a id="branch" href="#"
						class="btn-gradient gray block" role="button">가맹점</a>
			...
			<div class="step2">
				<form id="joinForm2" class="form-horizontal" method="post"
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									id="confirm" placeholder="비밀번호를 한번 더 입력해주세요" />
							</div>
						</div>
					</div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-users fa"
									aria-hidden="true"></i></span> <input type="text" class="form-control"
									name="name" id="name" placeholder="이름을 입력해주세요" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-users fa"
									aria-hidden="true"></i></span> <input type="text" class="form-control"
									name="nickName" id="nickName" placeholder="닉네임을 입력해주세요" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-users fa"
									aria-hidden="true"></i></span> <input type="text" class="form-control"
									name="phoneNum" id="phoneNum" placeholder="연락처를 입력해주세요" />
							</div>
						</div>
					</div>
					...
					<div class="form-group" id="registNum">
						<label for=registNum class="cols-sm-2 control-label">사업자
							등록번호</label>
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user fa"
									aria-hidden="true"></i></span> <input type="text" class="form-control"
									name="registNum" id="registNum2" placeholder="사업자 등록번호를 입력해주세요" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<div class="dropdown">
									<button id="quizChoice"
										class="btn btn-default dropdown-toggle quizChoice"
										type="button" data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="true" style="width: 100%">
										학창시절 기억에 남는 선생님은? <span class="caret"></span>
									</button>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-lock fa"
									aria-hidden="true"></i></span> <input type="text" class="form-control"
									name="pwQuestion" id="pwQuestion" placeholder="정답을 입력해주세요" />
							</div>
						</div>
					</div>
			...
			<a href="#" class="close-modal" rel="modal:close"
	...
	<div id="login" class="modal">
		...
		<div id="loginForm">
			<form style="width: 70%; margin: 0px auto; padding-top: 50px;">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user fa"
								...
								class="form-control id" name="id" placeholder="아이디를 입력해주세요"
				...
				<a onclick="loginCheck()"><input type="button" id="loginCheck"
					class="btn btn-primary"
					style="padding-left: 10px; width: 100%; font-size: 20px; margin-top: 10px;"
					value="로그인" /></a>
			</form>
			...
			<div style="width: 90%; margin-top: 30px;">
                ...
                <div id="naver_id_login" >
	                <script>
		                var naver_id_login = new naver_id_login("2d7hDqSzyOEeQOrhGnyg", "http://localhost:8080/");
            ...
            <div id="naverIdLogin"></div>
				...
				<div id="footerLogin">
					<a id="findID">아이디 찾기</a> <a id="findPW">비밀번호찾기</a> <a
						id="login-join" onclick="loginJoin()">회원가입</a>
				</div>
			</div>
		...
		<div id="login-findID">
			...
			<form class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user fa"
								aria-hidden="true"></i></span> <input type="text"
								class="form-control name" name="name" placeholder="이름을 입력해주세요" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<input type="button" id="findID_btn" class="btn btn-default"
						value="아이디찾기" />
				</div>
		...
		<div id="login-findPW"
			...
			<form class="form-horizontal">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user fa"
								aria-hidden="true"></i></span>
							<div class="dropdown">
								<button class="btn btn-default dropdown-toggle quizChoice"
									type="button" data-toggle="dropdown" aria-haspopup="true"
									aria-expanded="true" style="width: 100%">
									학창시절 기억에 남는 선생님은? <span class="caret"></span>
								</button>
				...
				<div class="form-group">
					<input type="button" id="findPW_btn" class="btn btn-default"
						value="비밀번호찾기" />
				</div>
				<a onclick="loginBack();">뒤로가기</a>
			</form>
				...
				<div class="form-group">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa fa-lock fa-lg" aria-hidden="true"></i></span> <input
								type="password" class="form-control pw" name="password"
								placeholder="비밀번호를 입력해주세요" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa fa-lock fa-lg" aria-hidden="true"></i></span> <input
								type="password" class="form-control confirm" name="confirm"
	...
	<div id="modal2" class="modal">
		<div class="detailModalTop">
			<div class="detailModalTopTitle">가맹점 신청</div>
			<div class="detailModalTopCategory">1 / 3단계</div>
		</div>
	...
	<div id="modal3" class="modal">
		...
		<div class="detailModalLeft">
			...
			<div class="popup-gallery popup-gallery2">
				<a class="imgLink1" href=""><img src="" width="60" height="60"
					class="galleryimg img1"></a> <a class="imgLink2" href=""><img
					src="" width="60" height="60" class="galleryimg img2"></a> <a
					class="imgLink3" href=""><img src="" width="60" height="60"
					class="galleryimg img3"></a> <a class="imgLink4" href=""><img
					src="" width="60" height="60" class="galleryimg img4"></a> <a
					class="imgLink5" href=""><img src="" width="60" height="60"
					class="galleryimg img5"></a> <a class="imgLink6" href=""><img
					src="" width="60" height="60" class="galleryimg img6"></a> <a
					class="imgLink7" href=""><img src="" width="60" height="60"
					class="galleryimg img7"></a> <a class="imgLink8" href=""><img
					src="" width="60" height="60" class="galleryimg img8"></a>
		...
		<div class="detailModalRight">
			<div class="modalStatusDiv" style="text-align: center;">
				<div class="modalScore"
					style="width: 330px; text-align: right; margin-right: 100px;"></div>
				<div class="modalStatus"
					...
					<div class="ticketingText"
						style="display: inline-block; margin-right: 20px;"></div>
			...
			<div class="modalJibunAddress"></div>
			<div>
...
<%--member join--%>
<script
	src="${pageContext.request.contextPath}/resources/js/header_js/member_join.js?ver=3"
	charset="UTF-8"></script>
<%--member login--%>
<script
...
<%--branch Insert modal--%>
<script
	src="${pageContext.request.contextPath}/resources/js/header_js/branch_insert.js?ver=3"
	charset="UTF-8"></script>
<%--mybranch modal--%>
<script
	src="${pageContext.request.contextPath}/resources/js/header_js/mybranch.js?ver=3"
	charset="UTF-8"></script>
<%--etc : markerImageList() && loadFile--%>
<script
	src="${pageContext.request.contextPath}/resources/js/header_js/etc.js?ver=3"
	charset="UTF-8"></script>
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.js"></script>